...
type BadgeType = 'neutral' | 'motero' | 'workshop' | 'brand';
...
export class MarkerBadgeComponent {
  ...
  getClasses(): string {
    ...
    const styles: Record<string, string> = {
      ...
      motero: "bg-colabb-tech-blue-light text-[#006064] border-colabb-tech-blue -rotate-2",
      workshop: "bg-colabb-lime-light-light text-black border-colabb-lime-light rotate-1 font-black",
